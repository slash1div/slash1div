...
local Configuration = {
QualityLevel = Enum.QualityLevel.Level21, -- Upto Level21
SavedQualityLevel = Enum.SavedQualitySetting.QualityLevel10,
LightingTechnology = Enum.Technology.Future,
ModelLevelOfDetail = Enum.ModelLevelOfDetail.StreamingMesh,
InterpolationThrottlingMode = Enum.InterpolationThrottlingMode.Enabled,
MeshPartDetailLevel = Enum.MeshPartDetailLevel.Level04,
MeshPartHeads = Enum.MeshPartHeads.Enabled,
EagerBulkExecution = true, -- Rendering budget limit
GlobalShadows = true, -- Shadows on
TerrainDecoration = true, -- Grass on
